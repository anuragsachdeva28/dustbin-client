...
class SignInForm extends Component {
  ...
  componentDidMount() {
      console.log("this is here",this.props)
  }
  ...
  handleSubmit = (e) => {
    ...
    setTimeout( ()=>{
      ...
      if(this.props.authError){
        ...
        console.log("now checking for client")
  ...
  componentWillReceiveProps(nextProps) {
    if(nextProps.client){
      console.log("no error and is a client")
      ...
      console.log("no error but not a client")
      this.props.signOut()
    }
  }
    ...
    return (
      <div className="FormCenter">
        ...
        >
          ...
          { authError ? <p className="authError red">Wrong Email or Password</p> : null }
